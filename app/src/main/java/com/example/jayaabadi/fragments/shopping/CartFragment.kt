...
import com.example.jayaabadi.adapters.CartProductAdapter
import com.example.jayaabadi.databinding.FragmentCartBinding
...
import com.example.jayaabadi.viewmodel.CartViewModel
        ...
        lifecycleScope.launchWhenStarted {
            viewModel.productsPrice.collectLatest { price ->
                price?.let {
                    ...
                    binding.tvTotalPrice.text = formatRupiah.format(price)
                }
            }
        }
